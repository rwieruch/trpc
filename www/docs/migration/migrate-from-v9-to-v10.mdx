...
3.1. Rename your old `appRouter` to `legacyRouter`
3.2. Create a new app router:
...
3.3. See if your app still builds
3.4. Create a a test router:
...
**6. If you're a React-user, upgrade to `@tanstack/react-query` `4`**

See migration guide at https://tanstack.com/query/v4/docs/guides/migrating-to-react-query-4
